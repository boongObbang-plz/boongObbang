...
const GoogleLoginButton = () => {
    return (
        <div className="w-[70%] h-[60px] bg-[#FFFFFF] rounded-[12px] text-center text-[16px] min-[400px]:text-[20px] min-[500px]:text-[22px] min-[600px]:text-[25px] text-[#191919] relative mb-[2%] font-sans">
