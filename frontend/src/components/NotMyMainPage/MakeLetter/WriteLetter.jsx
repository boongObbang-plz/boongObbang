    ...
    <>
        ...
        <div className="h-[100%] flex flex-col items-start justify-between text-left">
            <div className="w-72 flex justify-between mt-2">
                ...
                <input type="text" className="w-52 h-8  border-l-[25px] border-[#DDDCDC] bg-[#DDDCDC] rounded-lg focus:outline-0" onChange={onChangeTo} value={writeLetter.to} />
            </div>
            <textarea type="text" className="w-72 h-96 border-[25px] border-[#DDDCDC] bg-[#DDDCDC] rounded-lg  mt-4 focus:outline-0" onChange={onChangeMessage} value={writeLetter.message} />
            <div className="w-72 flex justify-between mt-4">
                <div className="w-20 flex justify-center text-lg ">From</div>
                <input type="text" className="w-52 h-8  border-l-[25px] border-[#DDDCDC] bg-[#DDDCDC] rounded-lg focus:outline-0" onChange={onChangeFrom} value={writeLetter.from} />
            </div>
        </div>
    </>
    )
