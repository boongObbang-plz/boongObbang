...
const PreView = ({ setColorValue, setLightValue }) => {
    ...
    return (
        <div className="w-[100%] flex flex-col items-center">
            ...
            <RadioGroup label="">
				<Radio name="roof" value="0" defaultChecked="false" disabled="false">
					<div className="w-[55px] h-[55px] bg-[#DF6F5F] rounded-[20px] border-4 border-[#FCF6EB]"></div>
				</Radio>
				<Radio name="roof" value="1" defaultChecked="false" disabled="false">
                    <div className="w-[55px] h-[55px] bg-[#F48E35] rounded-[20px] border-4 border-[#FCF6EB]"></div>
				</Radio>
				<Radio name="roof" value="2" defaultChecked="false" disabled="false">
                    <div className="w-[55px] h-[55px] bg-[#9FB433] rounded-[20px] border-4 border-[#FCF6EB]"></div>
				</Radio>
				<Radio name="roof" value="3" defaultChecked="false" disabled="false">
            ...
            <RadioGroup label="">
				<Radio name="light" value="0" defaultChecked="false" disabled="false">
					<div className="w-[55px] h-[55px] bg-[#FCF6EB] rounded-[20px] border-4 border-[#FCF6EB]">
                        <img src={light0}/>
                    </div>
				</Radio>
				<Radio name="light" value="1" defaultChecked="false" disabled="false">
                    <div className="w-[55px] h-[55px] bg-[#FCF6EB] rounded-[20px] border-4 border-[#FCF6EB]">
                        <img src={light1}/>
                    </div>
				</Radio>
				<Radio name="light" value="2" defaultChecked="false" disabled="false">
                    <div className="w-[55px] h-[55px] bg-[#FCF6EB] rounded-[20px] border-4 border-[#FCF6EB]">
                        <img src={light2}/>
                    </div>
				</Radio>
				<Radio name="light" value="3" defaultChecked="false" disabled="false">
                    <div className="w-[55px] h-[55px] bg-[#FCF6EB] rounded-[20px] border-4 border-[#FCF6EB]">
                        <img src={light3}/>
                    </div>
				</Radio>
