  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "yellow-blink": "yellow-blink 1s cubic-bezier(0.39, 0.58, 0.57, 1) infinite;",
        "green-blink": "green-blink 1s cubic-bezier(0.39, 0.58, 0.57, 1) infinite;",
        "blue-blink": "blue-blink 1s cubic-bezier(0.39, 0.58, 0.57, 1) infinite;",
        "pink-blink": "pink-blink 1s cubic-bezier(0.39, 0.58, 0.57, 1) infinite;",
        "purple-blink": "purple-blink 1s cubic-bezier(0.39, 0.58, 0.57, 1) infinite;"
      },
      keyframes: {
        "red-blink": {
